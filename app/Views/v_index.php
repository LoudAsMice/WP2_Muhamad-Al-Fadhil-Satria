<section>
    ...
    <p align = 'justify'>Pada pengertian CodeIgniter diatas tadi dijelaskan bahwa codeigniter menggunakan teknik mvc.
        Apa itu MVC? Kita juga harus mengetahui apa itu MVC sebelum masuk lebih jauh dalam belajar codeigniter</p>
    <p>MVC adalah teknik atau konsep yang memisahkan komponen utama menjadi 3 komponen yaitu model, view, controller.</p>
    <ol type="a"></ol>
    <li>Model</li>
    ...
    <p align=’justify’>Dari penjelasan tentang model view dan controller di atas dapat di simpulkan bahwa controller sebagai penghubung 
            ...
            dan sangat mudah dalam pengembangan aplikasi dengan cara mvc ini karena web designer atau front-end developer tidak perlu lagi 
